...
- it has a couple options in the 15 first lines of the script that let you customize the args it uses, where it take the player yamls and where it put the final zips
